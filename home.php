...
<div class="d-flex" id="wrapper">
  ...
  <div id="sidebar-wrapper" class="p-3">
    ...
    <div class="list-group list-group-flush">
     <a href="home" class="list-group-item list-group-item-action <?= ($currentPage == 'home.php') ? 'active-page' : '' ?>">
      ...
      <a href="kelola-admin" class="list-group-item list-group-item-action <?= ($currentPage == 'kelola-admin') ? 'active-page' : '' ?>">
