...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        if ($nama_sudah_ada) {
            ...
            header("Location: struktur-organisasi?sukses=replaced");
        } else {
            ...
            $stmt->execute();
            $stmt->close();
            header("Location: struktur-organisasi?sukses=updated");
        }
    } else {
        // === Mode TAMBAH ===
        ...
        if ($sudah_ada) {
            ...
            $stmt->execute();
            $stmt->close();
            header("Location: struktur-organisasi?sukses=inserted");
        }
    }
    exit;
}
...
if (isset($_GET['hapus_id'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: struktur-organisasi?sukses=deleted");
    exit;
}
  ...
  <div id="sidebar-wrapper" class="p-3">
    ...
    <div class="list-group list-group-flush">
      ...
      <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" 
        ...
        href="#profilMenu" 
        aria-expanded="<?= in_array($currentPage, ['sejarah.php', 'visi-misi.php', 'struktur-organisasi.php']) ? 'true' : 'false' ?>">
        <div><i class="fas fa-school me-2"></i> Profil</div>
        <i class="fas fa-caret-down"></i>
      </a>

      <div class="collapse <?= in_array($currentPage, ['sejarah.php', 'visi-misi.php', 'struktur-organisasi.php']) ? 'show' : '' ?>" id="profilMenu">
        ...
        <a href="visi-misi" class="list-group-item list-group-item-action <?= ($currentPage == 'visi-misi.php') ? 'active-page' : '' ?>">
          <i class="fas fa-lightbulb me-2"></i> Visi & Misi
        </a>
        <a href="struktur-organisasi" class="list-group-item list-group-item-action <?= ($currentPage == 'struktur-organisasi.php') ? 'active-page' : '' ?>">
